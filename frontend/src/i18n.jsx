...
const STRINGS = {
  ru: {
    ...
    "live.on": "● LIVE",
    "live.off": "○ ПАУЗА",
    "watch.button": "Мои пары ({n})",
    "watch.title": "Выберите до {max} пар",
    "watch.all": "Показать все",
    "lang.label": "Язык",
  ...
  en: {
    ...
    "live.on": "● LIVE",
    "live.off": "○ PAUSED",
    "watch.button": "My pairs ({n})",
    "watch.title": "Pick up to {max} pairs",
    "watch.all": "Show all",
    "lang.label": "Language",
